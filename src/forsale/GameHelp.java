...
public final class GameHelp {
    ...
    public static String[] overviewLines() {
        return new String[] {
            TITLE,
            "",
            "GOAL: Earn the most checks in Phase 2 (+ coins left).",
            "",
            ...
            "  4 checks dealt (highest value first).",
            "  Each player gives one property card face down.",
            "  All reveal: highest property wins the top check.",
            "  That check is added to that player's total.",
            "  2nd highest property wins 2nd check, etc.",
            "  Winner = most checks + leftover coins.",
            "",
    ...
    public static String[] commandLines() {
        return new String[] {
            ...
            "",
            "Selling (your turn):",
            "  <number>  — pick property by list number",
            "",
            "Anywhere:",
